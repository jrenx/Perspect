...
addr2line = {}
addr2line[0x1078a28]="4.2.1/src/third_party/wiredtiger/src/reconcile/rec_row.c:924"
addr2line[0x1078b47]="4.2.1/src/third_party/wiredtiger/src/reconcile/rec_row.c:924"
addr2line[0x10789f0]="4.2.1/src/third_party/wiredtiger/src/include/btree.i:845"
addr2line[0x10789f0]="4.2.1/src/third_party/wiredtiger/src/include/btree.i:845|4.2.1/src/third_party/wiredtiger/src/reconcile/rec_row.c:919"
addr2line[0x1078b54]="4.2.1/src/third_party/wiredtiger/src/reconcile/rec_row.c:924"
addr2line[0x1078b58]="4.2.1/src/third_party/wiredtiger/src/reconcile/rec_row.c:924"
addr2line[0x1014ba5]="4.2.1/src/third_party/wiredtiger/src/include/btree.i:988|4.2.1/src/third_party/wiredtiger/src/btree/row_key.c:112"
addr2line[0xf3ff11]="4.0.13/src/third_party/wiredtiger/src/reconcile/rec_row.c:848"
addr2line[0xee467]="4.0.13/src/third_party/wiredtiger/src/include/btree.i:984|4.0.13/src/third_party/wiredtiger/src/btree/row_key.c:112"
...
class Proportion:
    ...
    def __str__(self):
        ...
        #    s += "and weighted distrib (mean: {:.2f}".fwrrmat(self.w_mu) + ", std: {:.2f}".format(self.w_std) + ")"
        s += "\n"
        return s
...
class Relation:
    ...
    def __str__(self):
        s = ""
        s += "  >>> "# + str(self.key) + " "
        if self.insn in addr2line:
            s += addr2line[self.insn] + " "
        ...
        s += "<<<\n"
        s += "  " + str(self.weight) + "\n"
        s += "  => forward  relation:  " + str(self.forward)
        s += "  => backward relation: " + str(self.backward)
        s += "-----------------\n"
        return s
